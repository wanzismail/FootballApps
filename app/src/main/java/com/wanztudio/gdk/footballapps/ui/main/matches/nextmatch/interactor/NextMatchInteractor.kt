...
class NextMatchInteractor @Inject internal constructor(apiHelper: ApiHelper) : BaseInteractor(apiHelper), NextMatchMVPInteractor {

    override fun getNextMatchApiCall(idLeague : String) =
            apiHelper.getNextMatch(idLeague)
